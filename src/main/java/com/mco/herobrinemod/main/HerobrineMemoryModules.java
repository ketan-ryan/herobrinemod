...
public class HerobrineMemoryModules {
    ...
    public static final RegistryObject<MemoryModuleType<Unit>> BREATHE_FIRE_COOLDOWN = MEMORY_MODULES.register("breathe_fire_cooldown",
            () -> new MemoryModuleType<>(Optional.of(Codec.unit(INSTANCE))));

    public static final RegistryObject<MemoryModuleType<Unit>> BREATHE_FIRE_DELAY = MEMORY_MODULES.register("breathe_fire_delay",
            () -> new MemoryModuleType<>(Optional.of(Codec.unit(INSTANCE))));
