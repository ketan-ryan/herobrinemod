...
public class LayerHerobrineEyes<T extends EntityHerobrine> implements LayerRenderer<T>{
    ...
    private final RenderHerobrine herobrineRenderer;

    public LayerHerobrineEyes(RenderHerobrine renderHerobrine)
    {
