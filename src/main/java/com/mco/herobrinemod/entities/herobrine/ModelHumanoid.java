...
public class ModelHumanoid extends AdvancedLibModelBase {
    ...
    public ModelHumanoid() {
        ...
        this.RLegA.setRotationPoint(1.9F, 6.0F, 0.0F);
        ...
        this.LLegA.setRotationPoint(-1.9F, 6.0F, 0.0F);
        this.LLegA.addBox(-2.0F, 0.0F, -2.0F, 4, 6, 4, 0.0F);
        this.ChestB = new AdvancedModelRenderer(this, 16, 22);
        this.ChestB.setRotationPoint(0.0F, 6.0F, 0.0F);
        this.ChestB.addBox(-4.0F, 0.0F, -2.0F, 8, 6, 4, 0.0F);
        this.LArmB = new AdvancedModelRenderer(this, 40, 24);
        ...
        this.RLegB = new AdvancedModelRenderer(this, 16, 54);
